				...
				else
				{
					...
					if (figureType > 0)
					{
						...
						switch (figureType)
						{
							...
							case 2:
							{
								cont.add(std::shared_ptr<Triangle>(new Triangle(std::cin)));
							...
							case 3:
							{
								cont.add(std::shared_ptr<Octangle>(new Octangle(std::cin)));
						...
						case 1:
						{
							...
							if (figureType > 0)
							{
								...
								switch (figureType)
								{
									...
									case 2:
									{
										cont.erase(CriteriaType<Figure>("Triangle"));
									...
									case 3:
									{
										cont.erase(CriteriaType<Figure>("Octangle"));
